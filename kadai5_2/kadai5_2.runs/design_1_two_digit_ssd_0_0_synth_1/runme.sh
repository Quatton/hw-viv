...
HD_PWD='C:/Users/atomi/GitHub/hw-viv/kadai5_2/kadai5_2.runs/design_1_two_digit_ssd_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_two_digit_ssd_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_two_digit_ssd_0_0.tcl
