...
HD_PWD='C:/Users/atomi/GitHub/hw-viv/kadai5_2/kadai5_2.runs/design_1_c_shift_ram_2_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_c_shift_ram_2_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_c_shift_ram_2_1.tcl
