...
HD_PWD='C:/Users/atomi/GitHub/hw-viv/renshu/renshu.runs/design_2_util_vector_logic_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_2_util_vector_logic_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_2_util_vector_logic_0_0.tcl
