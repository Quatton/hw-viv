...
HD_PWD='C:/Users/atomi/GitHub/hw-viv/kadai5/kadai5.runs/design_1_two_digit_ssd_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_two_digit_ssd_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_two_digit_ssd_0_1.tcl
