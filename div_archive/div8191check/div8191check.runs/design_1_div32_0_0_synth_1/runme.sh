...
HD_PWD='C:/Users/atomi/GitHub/hw-viv/div_archive/div32check/div32check.runs/design_1_div32_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_div32_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_div32_0_0.tcl
