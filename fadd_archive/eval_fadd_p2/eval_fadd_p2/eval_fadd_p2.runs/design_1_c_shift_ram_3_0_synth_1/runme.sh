...
HD_PWD='D:/fadd_archive/eval_fadd_p2/eval_fadd_p2/eval_fadd_p2.runs/design_1_c_shift_ram_3_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_c_shift_ram_3_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_c_shift_ram_3_0.tcl
